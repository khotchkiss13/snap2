...
IDE_Morph.prototype.setDefaultColor = function () {
	MorphicPreferences.isLight = false;
...
IDE_Morph.prototype.setLightColor = function () {
	MorphicPreferences.isLight = true;
...
IDE_Morph.prototype.setDefaultColor();
...
IDE_Morph.prototype.createLogo = function () {
    ...
    this.logo.drawNew = function () {
        ...
        context.fillStyle = MorphicPreferences.isLight ?
...
IDE_Morph.prototype.createControlBar = function () {
    ...
    this.controlBar.updateLabel = function () {
        ...
        this.label = new StringMorph(
            ...
            false,
            false,
            MorphicPreferences.isLight ? null : new Point(2, 1),
...
IDE_Morph.prototype.createSpriteBar = function () {
    ...
    padlock.tick.shadowOffset = MorphicPreferences.isLight ?
...
IDE_Morph.prototype.defaultColor = function () {
...
IDE_Morph.prototype.lightColor = function () {
	this.setLightColor();
	this.refreshIDE();
	this.saveSetting('color', 'light');
}
...
IDE_Morph.prototype.cloudIcon = function (height, color) {
    var clr = color || DialogBoxMorph.prototype.titleBarColor,
        isLight = MorphicPreferences.isLight,
        icon = new SymbolMorph(
            isLight ? 'cloud' : 'cloudGradient',
            height || 50,
            clr,
            isLight ? null : new Point(-1, -1),
            clr.darker(50)
        );
    if (!isLight) {
...
TurtleIconMorph.prototype.createThumbnail = function () {
    var isLight = MorphicPreferences.isLight;
